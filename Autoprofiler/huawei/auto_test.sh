...
if [ "$do_name" = "slide" ]; then
   sh ./slide.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ $do_name = "change" ]; then
   if [ $app_name = "booking" ]; then
	sh ./change_huawei_book.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "didi" ]; then
	sh ./change_huawei_didi.sh & . ./huawei_IPC4_cycle_less6.sh
#   elif [ $app_name = "netease" ]; then
#	sh ./change_huawei_nte.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "qqmail" ]; then
	sh ./change_huawei_qqmail.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "wiz" ]; then
	sh ./change_huawei_wiz.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "facebook" ]; then
	sh ./change_huawei_facebook.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "messenger" ]; then
	sh ./change_huawei_messenger.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "telegram" ]; then
	sh ./change_huawei_telegram.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "amazonshop" ]; then
	sh ./change_huawei_amazonshop.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "amazonmusic" ]; then
	sh ./change_huawei_amazonmusic.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "dealspure" ]; then
	sh ./change_huawei_dealspure.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "twitch" ]; then
	sh ./change_huawei_twitch.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "facebookgaming" ]; then
	sh ./change_huawei_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "kindle" ]; then
	sh ./change_huawei_kindle.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "youtube" ]; then
	sh ./change_huawei_youtube.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "playgame" ]; then
	sh ./change_huawei_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "bigolive" ]; then
	sh ./change_huawei_bigolive.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "joox" ]; then
	sh ./change_huawei_joox.sh & . ./huawei_IPC4_cycle_less6.sh
   else 
	sh ./change_huawei.sh & . ./huawei_IPC4_cycle_less6.sh
   fi
   ...
   sh ./quench.sh  & . ./huawei_IPC4_cycle_less6.sh
