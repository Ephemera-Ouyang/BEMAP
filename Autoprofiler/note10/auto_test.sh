...
if [ "$do_name" = "slide" ]; then
   sh ./slide.sh & . ./mi_IPC4_cycle.sh
elif [ $do_name = "change" ]; then
   if [ $app_name = "booking" ]; then
	sh ./change_mi_book.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "didi" ]; then
	sh ./change_mi_didi.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "qqmail" ]; then
	sh ./change_mi_qqmail.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "wiz" ]; then
	sh ./change_mi_wiz.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "facebook" ]; then
	sh ./change_mi_facebook.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "messenger" ]; then
	sh ./change_mi_messenger.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "telegram" ]; then
	sh ./change_mi_telegram.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "amazonmusic" ]; then
	sh ./change_mi_amazonmusic.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "dealspure" ]; then
	sh ./change_mi_dealspure.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "twitch" ]; then
	sh ./change_mi_twitch.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "facebookgaming" ]; then
	sh ./change_mi_facebookgaming.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "kindle" ]; then
	sh ./change_mi_kindle.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "youtube" ]; then
	sh ./change_mi_youtube.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "playgame" ]; then
	sh ./change_mi_facebookgaming.sh & . ./mi_IPC4_cycle.sh
   elif [ $app_name = "joox" ]; then
	sh ./change_mi_joox.sh & . ./mi_IPC4_cycle.sh
   else 
	sh ./change_mi.sh & . ./mi_IPC4_cycle.sh
   fi
elif [ $do_name = "search" ]; then
   sh ./search.sh & . ./mi_IPC4_cycle.sh
elif [ "$do_name" = "playmusic" ]; then
   sh ./playmusic.sh & . ./mi_IPC4_cycle.sh
elif [ "$do_name" = "playradio" ]; then
   sh ./playradio.sh & . ./mi_IPC4_cycle.sh
elif [ $do_name = "camera" ]; then
   sh ./camera.sh & . ./mi_IPC4_cycle.sh
elif [ $do_name = "open" ]; then
   sh ./open.sh  & . ./mi_IPC4_cycle.sh
elif [ $do_name = "quench" ]; then
   sh ./quench.sh  & . ./mi_IPC4_cycle.sh
