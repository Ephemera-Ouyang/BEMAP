...
if [ "$do_name" = "slide" ]; then
   ...
   if [ $app_name = "booking" ]; then
	...
	sh ./change_xiaomi_facebook.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "messenger" ]; then
	sh ./change_xiaomi_messenger.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "telegram" ]; then
	sh ./change_xiaomi_telegram.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "amazonmusic" ]; then
	sh ./change_xiaomi_amazonmusic.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "dealspure" ]; then
	sh ./change_xiaomi_dealspure.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "twitch" ]; then
	sh ./change_xiaomi_twitch.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "facebookgaming" ]; then
	sh ./change_xiaomi_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "kindle" ]; then
	sh ./change_xiaomi_kindle.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "youtube" ]; then
	sh ./change_xiaomi_youtube.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "playgame" ]; then
	sh ./change_xiaomi_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "joox" ]; then
	sh ./change_xiaomi_joox.sh & . ./huawei_IPC4_cycle_less6.sh
   else 
	sh ./change_huawei2.sh & . ./huawei_IPC4_cycle_less6.sh
   fi
