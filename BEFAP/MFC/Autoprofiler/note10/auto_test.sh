...
if [ "$app_name" = "totemweather" ]; then
   ...
   adb shell am start com.android.gallery3d/com.samsung.gallery.app.GalleryMain
   ...
   adb shell am start com.samsung.camera/com.samsung.camera
   ...
   adb shell am start com.wepie.snake.samsung/com.wepie.snake.app.activity.StartActivity
   ...
   adb shell am start com.netease.dwrg.samsung/com.netease.dwrg.Launcher
elif [ "$app_name" = "sky" ]; then
   adb shell am start com.netease.sky.samsung/com.tgc.sky.netease.GameActivity_Netease
   ...
   adb shell am start com.blizzard.wtcg.hearthstone.cn.samsung/com.blizzard.wtcg.hearthstone.HearthstoneActivity
   ...
   adb shell am start com.miHoYo.bh3.samsung/com.miHoYo.overridenativeactivity.OverrideNativeActivity
   ...
   adb shell am start com.minitech.miniworld.samsung/com.minitech.miniworld.MiniWorldActivity
   ...
   adb shell am start com.netease.onmyoji.samsung/com.netease.onmyoji.Launcher
...
if [ "$do_name" = "sliding" ]; then
   sh ./sliding.sh & . ./mi_IPC4_cycle.sh
elif [ $do_name = "switching" ]; then
   if [ $app_name = "booking" ]; then
	sh ./switching_samsung_book.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "didi" ]; then
	sh ./switching_samsung_didi.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "qqmail" ]; then
	sh ./switching_samsung_qqmail.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "wiz" ]; then
	sh ./switching_samsung_wiz.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "facebook" ]; then
	sh ./switching_samsung_facebook.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "messenger" ]; then
	sh ./switching_samsung_messenger.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "telegram" ]; then
	sh ./switching_samsung_telegram.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "amazonmusic" ]; then
	sh ./switching_samsung_amazonmusic.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "dealspure" ]; then
	sh ./switching_samsung_dealspure.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "twitch" ]; then
	sh ./switching_samsung_twitch.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "facebookgasamsungng" ]; then
	sh ./switching_samsung_facebookgasamsungng.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "kindle" ]; then
	sh ./switching_samsung_kindle.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "youtube" ]; then
	sh ./switching_samsung_youtube.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "playgame" ]; then
	sh ./switching_samsung_facebookgaming.sh & . ./samsung_IPC4_cycle.sh
   elif [ $app_name = "joox" ]; then
	sh ./switching_samsung_joox.sh & . ./samsung_IPC4_cycle.sh
   else 
	sh ./switching_samsung.sh & . ./samsung_IPC4_cycle.sh
   fi
elif [ $do_name = "search" ]; then
   sh ./search.sh & . ./samsung_IPC4_cycle.sh
elif [ "$do_name" = "playmusic" ]; then
   sh ./playmusic.sh & . ./samsung_IPC4_cycle.sh
elif [ "$do_name" = "playradio" ]; then
   sh ./playradio.sh & . ./samsung_IPC4_cycle.sh
elif [ $do_name = "camera" ]; then
   sh ./camera.sh & . ./samsung_IPC4_cycle.sh
elif [ $do_name = "open" ]; then
   sh ./open.sh  & . ./samsung_IPC4_cycle.sh
elif [ $do_name = "quenching" ]; then
   sh ./quenching.sh  & . ./samsung_IPC4_cycle.sh
elif [ "$do_name" = "none" ]; then
    . ./samsung_IPC4_cycle.sh
else
