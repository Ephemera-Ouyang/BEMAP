...
if [ "$do_name" = "sliding" ]; then
   sh ./sliding.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ $do_name = "switching" ]; then
   if [ $app_name = "booking" ]; then
	sh ./switching_huawei_book.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "didi" ]; then
	sh ./switching_huawei_didi.sh & . ./huawei_IPC4_cycle_less6.sh
#   elif [ $app_name = "netease" ]; then
#	sh ./switching_huawei_nte.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "qqmail" ]; then
	sh ./switching_huawei_qqmail.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "wiz" ]; then
	sh ./switching_huawei_wiz.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "facebook" ]; then
	sh ./switching_huawei_facebook.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "messenger" ]; then
	sh ./switching_huawei_messenger.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "telegram" ]; then
	sh ./switching_huawei_telegram.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "amazonshop" ]; then
	sh ./switching_huawei_amazonshop.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "amazonmusic" ]; then
	sh ./switching_huawei_amazonmusic.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "dealspure" ]; then
	sh ./switching_huawei_dealspure.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "twitch" ]; then
	sh ./switching_huawei_twitch.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "facebookgaming" ]; then
	sh ./switching_huawei_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "kindle" ]; then
	sh ./switching_huawei_kindle.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "youtube" ]; then
	sh ./switching_huawei_youtube.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "playgame" ]; then
	sh ./switching_huawei_facebookgaming.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "bigolive" ]; then
	sh ./switching_huawei_bigolive.sh & . ./huawei_IPC4_cycle_less6.sh
   elif [ $app_name = "joox" ]; then
	sh ./switching_huawei_joox.sh & . ./huawei_IPC4_cycle_less6.sh
   else 
	sh ./switching_huawei.sh & . ./huawei_IPC4_cycle_less6.sh
   fi
elif [ $do_name = "search" ]; then
   sh ./search.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ "$do_name" = "playmusic" ]; then
   sh ./playmusic.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ "$do_name" = "playradio" ]; then
   sh ./playradio.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ $do_name = "camera" ]; then
   sh ./camera.sh & . ./huawei_IPC4_cycle_less6.sh
elif [ $do_name = "open" ]; then
   sh ./open.sh  & . ./huawei_IPC4_cycle_less6.sh
elif [ $do_name = "quenching" ]; then
   sh ./quenching.sh  & . ./huawei_IPC4_cycle_less6.sh
elif [ "$do_name" = "none" ]; then
    . ./huawei_IPC4_cycle.sh
else
