...
:<<!
#lock frequency max()
adb shell "echo 1954000 > sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq"
#adb shell "echo little freq set 1954 > /d/hisi_lpm3_debug_lpm3_test"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq"
#adb shell "echo little freq set 1954 > /d/hisi_lpm3_debug_lpm3_test"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq"
#adb shell "echo little freq set 1954 > /d/hisi_lpm3_debug_lpm3_test"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq"
adb shell "echo 1954000 > sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq"
#adb shell "echo little freq set 1954 > /d/hisi_lpm3_debug_lpm3_test"
adb shell "echo 2360000 > sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq"
adb shell "echo 2360000 > sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq"
adb shell "echo 2360000 > sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq"

adb shell "echo 2360000 > sys/devices/system/cpu/cpu5/cpufreq/scaling_max_freq"
adb shell "echo 2360000 > sys/devices/system/cpu/cpu5/cpufreq/scaling_min_freq"
adb shell "echo 2360000 > sys/devices/system/cpu/cpu5/cpufreq/scaling_max_freq"

adb shell "echo 2861000 > sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq"
adb shell "echo 2861000 > sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq"
adb shell "echo 2861000 > sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq"

adb shell "echo 2861000 > sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq"
adb shell "echo 2861000 > sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq"
adb shell "echo 2861000 > sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq"
!
#lock frequency min()

app_name_list=("Alipay" "article" "autonavi" "baidu" "beike" "booking" "ctrip" "didi" "health" "homelink"
 "hwireader" "jingdong" "mediacenter" "mm" "netease" "pinduoduo" "qiyi" "qqlive" "qqmusic" "ss"
 "tmall" "UCMobile" "umetrip" "weibo" "ximalaya" "zhihu" "bili" "duapp" "gifmaker" "keep"
 "kiwi" "liulishuo" "meituan" "mooc" "reader" "taobao" "tieba" "xhs" "mtxx" "wiz"
 "coolapk" "fenbi" "netdisk" "wps" "xueersi" "xunlei" "yinxiang" "popcap" "AndroidAnimal" "pubgmhd"
 "antutu" "ludashi" "dianping" "autohome" "dragon" "ele" "cmb" "douyu" "jiayuan" "qqdownload"
 "qqmail" "mail" "qgame" "kuaikan" "video" "dwrg" "miniworld" "snake" "onmyoji" "sgame"
 "snapchat" "facebook" "messenger" "telegram" "amazonshop" "amazonmusic"
"dealspure" "twitch" "facebookgaming" "kindle"
 "youtube" "twitter" "instagram" "playgame" "googlemap" "calm" "bigolive" "carousell" "starmaker" "tango"
 "webtoon" "googledrive" "onedrive" "uplive" "joox" "easymoney" "shein" "reddit" "tubitv" "outlook" "Chrome" "Gmail")
 export app_name=${app_name_list[101]}
#56
#fre_list=("min" "middle")
#fre_list=("middle")
#fre_list=("min")
:<<!
for f in ${fre_list[@]};
do export fre_level=$f;
 if [ $fre_level = "min" ]; then
	bash lock_frequency_min.sh;
 elif [ $fre_level = "middle" ]; then
	bash lock_frequency_middle.sh;
 fi 
!
...
if [ "$app_name" = "totemweather" ]; then
   ...
   adb shell am start com.huawei.music/com.android.mediacenter.PageActivity
   ...
   adb shell am start com.wepie.snakeoff/com.wepie.snake.activity.HomeActivity
   ...
   adb shell am start com.tencent.tmgp.pvz2hdtxyyb/com.talkweb.twOfflineSdk.activity.PermisionActivity
   ...
   adb shell am start com.playmini.miniworld/com.minitech.miniworld.MiniWorldActivity
elif [ "$app_name" = "antutu" ]; then
   adb shell am start com.antutu.ABenchMark/com.example.ABenchMark.ABenchMarkStart
elif [ "$app_name" = "mail" ]; then
   ...
   adb shell am start com.dealspure.wild/.MainActivitys
 ...
 #do_name_list=("slide" "change" "quench")
 #do_name_list=("slide" "change")
 #do_name_list=("slide" "quench")
 #do_name_list=("slide")
 #do_name_list=("change" "slide" "quench")
 #do_name_list=("change" "quench")
 #do_name_list=("change")
 do_name_list=("quench")
