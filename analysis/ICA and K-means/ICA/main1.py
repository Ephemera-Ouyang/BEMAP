...
def get_feature_name(txt_dir):
    ...
    #file_handle = open(txt_dir + temp + 'Alipay.txt', 'r')  # 文件名 # 1.1
...
if __name__ == '__main__':
    ...
    txt_dir = './huawei_geekbench_second/'  # path which save txt file(original data)
    ...
    total_data_Excel_dir = './huawei_geekbench_second/geekbench_huawei_second_all.xlsx'  # after data operation, all data will save in this file
