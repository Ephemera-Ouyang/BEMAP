...
if __name__ == '__main__':
    ...
    txt_dir = './xiaomi-20220327-100/change/'  # path which save txt file(original data)

    # CPI_and_APP_dir = './geekbench/app.txt'
    # CPI_and_APP_dir = './APP.txt'
    # CPI_list,APP_list = get_APP_name(CPI_and_APP_dir)

    APP_list = get_APP_name_2('./xiaomi-20220327-100/APP2.txt')
    ...
    event_file_dir = './xiaomi-20220327-100/event2.txt' #xiaomi only use event2
    ...
    total_data_Excel_dir = './xiaomi-20220327-100/xiaomi_change_all-20-reddit.xlsx'  # after data operation, all data will save in this file
